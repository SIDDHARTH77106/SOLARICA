...
const Footer = () => {
  ...
  return (
    ...
    // Responsive Height: h-auto on mobile, sticky screen on desktop
    <div 
      ref={footerRef} 
      className="relative min-h-screen md:h-screen flex flex-col" 
    >
      
      {/* --- STICKY FIXED FOOTER BACKGROUND --- */}
      <div className="relative md:fixed bottom-0 left-0 w-full min-h-screen bg-[#0b120f] text-[#e8e4dc] flex flex-col justify-end overflow-hidden pt-20 md:pt-0">
        ...
        {/* BIG BACKGROUND GHOST TEXT */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-0 w-max hidden md:block">
            <motion.h1 
                style={{ y: yText, opacity: opacityText, scale: scaleText }}
                className="text-[15vw] font-black leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white/20 to-transparent select-none whitespace-nowrap uppercase text-center blur-sm"
            >
                APSTECH
            </motion.h1>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 pb-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-end mb-16">
            ...
            <div>
               ...
               >
                 ...
                 <h3 className="text-4xl md:text-7xl font-light mb-10 leading-[1.1] text-white">
                   Precision engineering <br/> 
                   <span className="font-serif italic text-transparent bg-clip-text bg-gradient-to-r from-[#5ce1e6] to-[#2e3192] font-bold">
                     for your vision.
                   </span>
                 </h3>
               </motion.div>

               {/* 3D Contact Cards (Stacked on Mobile) */}
               <div className="flex flex-col sm:flex-row gap-6 mt-12">
                 <div className="flex-1 p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-[#5ce1e6]/50 transition-all group backdrop-blur-sm">
            ...
            <div className="flex justify-start lg:justify-end perspective-1000 w-full">
                <motion.form 
                  style={{ y: window.innerWidth > 768 ? yForm : 0 }} // Disable parallax on mobile
                  whileHover={{ rotateX: 5, rotateY: -5, scale: 1.02 }}
                  transition={{ type: "spring", stiffness: 300 }}
                  className="space-y-6 w-full max-w-md bg-[#14201a]/80 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden group mx-auto lg:mx-0"
                >
                  {/* Glossy Reflection */}
          ...
          {/* --- BOTTOM BAR --- */}
          <div className="flex flex-col-reverse md:flex-row justify-between items-center md:items-end border-t border-white/5 pt-8 gap-6 text-center md:text-left">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-center md:justify-start gap-6 text-[10px] text-white/50 uppercase tracking-widest font-bold">
            ...
            <div className="flex flex-col items-center md:items-end">
                ...
                >
                    <span className="font-bold text-sm tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-[#5ce1e6] to-purple-400 group-hover:brightness-125 transition-all">
                       Siddharth Gautam
                    </span>
